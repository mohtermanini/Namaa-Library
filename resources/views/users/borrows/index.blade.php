...
@section('content')
    <a href="{{ route('subscriptions.index', ['user_id' => $user->id]) }}" class="btn btn-success ms-4">الاشتراكات</a>
    <div class="row mt-1 text-center">
        <div class="col">
            <a href="{{ route('borrows.create.internal', ['user_id' => $user->id]) }}" class="btn btn-primary ms-3">إضافة
                استعارة داخلية</a>
            <a href="{{ route('borrows.create.external', ['user_id' => $user->id]) }}" class="btn btn-primary">إضافة استعارة
                خارجية</a>
        </div>
    </div>
