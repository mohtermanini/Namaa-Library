    ...
    <nav class="navbar navbar-expand-md bg-dark navbar-dark p-3">
            ...
            <div class="d-flex w-100 justify-content-between">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('activities.index',['title'=>'مقهى الوظائف']) }}"
                            class="nav-link">مقهى الوظائف</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark dropdown-menu-end"
                            ...
                            <li><a class="dropdown-item"
                                    href="{{ route('borrows.index.internal') }}">الكتب
                                    المستعارة داخلياً</a></li>
                            <li><a class="dropdown-item"
                                    href="{{ route('borrows.index.external') }}">الكتب
